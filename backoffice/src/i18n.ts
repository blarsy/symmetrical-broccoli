...
const resources = {
    en: { 
        translation: {
            ...
            "optionalInstallAppOnboardingStep": "Optional: installe the app on your smartphone.",
            "webVersionAvailable": "You prefer a pure web version ? We got you covered, see below.",
            "createAnAccountOnboardingStep": "Create your account, on smartphone or on the website",
            "findMobileConnectionIcon": "On smartphone, look for this icon",
    ...
    fr: { 
        translation: {
            ...
            "optionalInstallAppOnboardingStep": "Optionnel: installe l'app sur ton smartphone.",
            "webVersionAvailable": "Tu préfères une version pure web ? On a ça aussi (voir ci-dessous).",
            "createAnAccountOnboardingStep": "Crée ton compte sur smartphone ou sur le site web",
            "findMobileConnectionIcon": "Sur smartphone, cherche cette icône",
            "or": "ou sur le web :",
            "registerButtonCaption": "S'enregistrer",
