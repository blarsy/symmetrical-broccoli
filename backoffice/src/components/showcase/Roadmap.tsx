...
const StepStone = (p: StepStoneProps) => {
    ...
    return <Stack flexDirection="row">
        <Stack justifyContent="center" sx={{ flex: '0 0 30%' }}>
            <Typography color="#000" textAlign="right" fontFamily={fonts.sugar.style.fontFamily} lineHeight={1} sx={{
                fontSize: 24,
        ...
        <Stack flex="0 0 50%">
            <Typography color="#000" lineHeight={1} fontFamily={fonts.title.style.fontFamily}sx={{
                fontSize: 32,
                [theme.breakpoints.down('lg')]: {
                    fontSize: 24
                },[theme.breakpoints.down('md')]: {
...
const Roadmap = () => {
    ...
    return <Stack flexDirection="row" justifyContent="center" sx={{
        ...
        <Stack sx={{ backgroundImage: `url('/sketchy-poster.svg')`,
            ...
            <Typography color="#000" textAlign="center" variant="h1">Feuille de route</Typography>
            ...
            <StepStone leftText={'Décembre 2024'} rightTextTitle={'Modèle économique'}  rightTextDetail={'Une rémunération juste pour la plateforme, collectée de manière équitable.'}/>
            <StepStone leftText={'Janvier 2025'} rightTextTitle={'Campagne de lancement'}  rightTextDetail={`Uh subside à l'économie circulaire en démocratie directe.`}/>
