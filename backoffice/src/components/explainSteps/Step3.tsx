...
const Step3 = () => <Stack alignContent="center" maxWidth={540}>
    <Typography style={{ transform: 'rotate(-3.7deg)', margin: '0.5rem' }} lineHeight={1} fontFamily={fonts.title.style.fontFamily} fontSize={48} color={primaryColor}>QU&rsquo;EST CE QU&rsquo;ON ENTEND PAR <Typography component="span" color="#000"fontFamily={fonts.title.style.fontFamily} lineHeight={1} fontSize={48}>RESSOURCES</Typography> ?</Typography>
