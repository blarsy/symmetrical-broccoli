...
import { graphQlApiUrl, linksUrl, subscriptionsUrl, apiUrl } from "@/lib/settings"
...
export default () => {
    ...
    const load = async () => {
        try {
            ...
            const supportInfo = {
                graphQlApiUrl, apiUrl, subscriptionsUrl, linksUrl, clientVersion: nativeApplicationVersion,
