...
const resources = {
  en: {
    translation: {
      ...
      "publicInfo_settings_title": "Your links",
      ...
      "lessInfo": "Less info",
      "moreInfo": "More info ...",
      "SwitchToContributionMode_DialogTitle": "Tope-là needs you !",
      "Contribution_tip": "{{numberOfFreeResources}} active resources are free : if you give, trade, or delete one, or it expires, you may create another without contributing.",
      "Contribution_explain1": "Beyong {{numberOfFreeResources}} resources, we swap each day of availability against 'Topes'",
      "Contribution_explain_token": "1 Tope = 1 resource available for 1 day",
      "Contribution_subTitle": "How to earn 'Topes' ?",
      "Contribution_explain2": "By performing actions in the app that make Tope-là grow.",
      "Contribution_gifts_title": "For you, when you become contributor:",
      "Contribution_gift_1": " You get 30 Topes immediately, so enough to advertise 1 resource for 30 days (or 2 resources for 15 days, ...)",
      "Contribution_gift_2": "All you need to know about contributing is accessible on your profile screen.",
      "Contribution_gift_3": "That's all, no trap, no add, no need to pay",
      "SwitchToContributionMode_Question": "So, are you joining us in growing solidarity and fair trade ?",
      ...
      "howItWorksAccordionTitle": "How does it work ?",
  ...
  fr: {
    translation: {
      ...
      "publicInfo_settings_title": "Vos liens",
      "faq_title": "Foire aux questions",
      "faq_button_label": "Questions",
      "look_for_me1": "Trouvez",
      ...
      "SwitchToContributionMode_DialogTitle": "Tope-là a besoin de toi !",
      "Contribution_tip": "Tu peux afficher {{numberOfFreeResources}} ressources en permanence: si tu en donnes, en échange, en efface une, ou qu'elle expire, tu peux en créer une autre sans devoir contribuer.",
      "Contribution_explain1": "Aù-delà de tes {{numberOfFreeResources}} premières ressources, on t'échange des jours d'affichage de tes ressources supplémentaire contre des 'Topes'",
      "Contribution_explain_token": "1 Tope = 1 ressource affichée pendant 1 jour",
      "Contribution_subTitle": "Comment gagner des 'Topes' ?",
      "Contribution_explain2": "En faisant des actions dans l'app qui font grandir la famille Tope-là.",
      "Contribution_gifts_title": "Pour toi, si tu acceptes de contribuer:",
      "Contribution_gift_1": "Tu reçois immédiatement 30 Topes, de quoi afficher 1 ressource pendant 30 jours (ou 2 ressources pendant 15 jours, ...)",
      "Contribution_gift_2": "Tous ce que tu dois savoir sur la contribution sera accessible dans ton écran de profil",
      "Contribution_gift_3": "C'est tout. Pas de piège, pas de publicité, pas d'obligation à payer",
      "SwitchToContributionMode_Question": "Alors, tu contribues avec nous à faire grandir la solidarité et les échanges ?",
      "resourcesWithoutPic": "ressources sans photo",
      "howToGet_addLink": "Ajouter un lien qui parle de vous",
      "howToGet_addLocation": "Entrer votre adresse sur votre profil",
      ...
      "tokenName": "Tope(s)",
      "token_settings_title": "Contribution",
      "howItWorksAccordionTitle": "Comment ça marche ?",
