...
const resources = {
  en: {
    translation: {
      ...
      "resourceConsumption": "Those resources will consume a 'Tope' each day. 1 Tope = 1 eurocent",
  ...
  fr: {
    translation: {
      ...
      "resourceConsumption": "Ces ressources vont consommer un 'Tope' par jour. Et un Tope, ça vaut 1 cent d'euro.",
