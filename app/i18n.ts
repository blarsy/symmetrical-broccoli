...
const resources = {
  en: {
    translation: {
      ...
      "createResourcesInCampaignExplanation": "Create resources within the theme of this campaign",
  ...
  fr: {
    translation: {
      ...
      "tokensProfileLabel": "Portefeuille",
